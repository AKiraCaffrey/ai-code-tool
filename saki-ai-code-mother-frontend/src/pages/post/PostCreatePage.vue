  ...
  <div class="post-create-page">
    <div class="nav-container">
      <div class="nav-content">
        <div class="nav-left">
          <img src="@/assets/ZeroCode-TextAndLogo.png" alt="Logo" class="logo" @click="goHome" />
        </div>
        <div class="nav-right">
          <a-button @click="handlePreview" :disabled="!canPreview">预览</a-button>
          <a-button type="primary" @click="handlePublish" :loading="publishing" :disabled="!canPublish">发布</a-button>
        </div>
      </div>
    </div>
